...
(function() {
    ...
    function crearControlesSeleccion(ubicacionesProyecto, nombreProyecto) {
        ...
        ubicacionesProyecto.forEach((ubicacion, index) => {
            ...
            infoSpan.textContent = `Recursos Estrategicos: $${ubicacion.attributes.valorinversion.toLocaleString()}`;
            ...
            Object.entries(proyectosPorNombre).forEach(([nombreProyecto, proyectosGrupo]) => {
                ...
                let contenido = `
                    ...
                    <div class="project-details">
                        <span class="project-cost">Recursos Estrategicos: $${proyectoMasBarato.attributes.valorinversion.toLocaleString()}</span>
